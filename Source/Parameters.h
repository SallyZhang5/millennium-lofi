...
{
    return { "关闭", "24 kbps · 电话音质", "32 kbps · 早期彩铃", "48 kbps · 廉价 MP3",
             "64 kbps · 千禧随身听", "96 kbps · 常见下载", "128 kbps · 当年标准",
             "192 kbps · 接近 CD", "320 kbps · 几乎无损" };
}
...
inline const std::vector<FactoryPreset>& factoryPresets()
{
    ...
    {
        { "千禧 MP3 随身听", "2000 年前后最典型的声音：64 kbps 下载曲、塑料耳塞",
        ...
        { "早期手机彩铃", "8 kHz 单声道、8 位颗粒，就是当年那支彩铃",
